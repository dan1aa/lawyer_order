...
function lawyer_scripts() {
	wp_enqueue_style( 'lawyer-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'lawyer-style', 'rtl', 'replace' );

	wp_enqueue_script( 'lawyer-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
	wp_enqueue_style( 'lawyer-main-style', get_template_directory_uri() . "/assets/css/style.css", array(), _S_VERSION );
	wp_enqueue_style( 'lawyer-news-style', get_template_directory_uri() . "/assets/css/news.css", array(), _S_VERSION );
